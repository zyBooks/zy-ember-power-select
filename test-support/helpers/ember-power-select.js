...
import _registerHelpers from 'zy-ember-power-select/test-support/helpers';
import {
...
} from 'zy-ember-power-select/test-support/helpers';

function deprecateHelper(fn, name) {
  return function(...args) {
    deprecate(
      `DEPRECATED \`import { ${name} } from '../../tests/helpers/ember-power-select';\` is deprecated. Please, replace it with \`import { ${name} } from 'zy-ember-power-select/test-support/helpers';\``,
      false,
...
export default function deprecatedRegisterHelpers() {
  deprecate(
    "DEPRECATED `import registerPowerSelectHelpers from '../../tests/helpers/ember-power-select';` is deprecated. Please, replace it with `import registerPowerSelectHelpers from 'zy-ember-power-select/test-support/helpers';`",
    false,
